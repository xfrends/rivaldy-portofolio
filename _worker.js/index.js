...
import { manifest } from './manifest_DK3eWJFT.mjs';
...
const _page9 = () => import('./pages/admin/pricelist/create.astro.mjs');
const _page10 = () => import('./pages/admin/pricelist/_id_/edit.astro.mjs');
const _page11 = () => import('./pages/admin/pricelist.astro.mjs');
const _page12 = () => import('./pages/admin.astro.mjs');
const _page13 = () => import('./pages/api/admin/collections.astro.mjs');
const _page14 = () => import('./pages/api/admin/content.astro.mjs');
const _page15 = () => import('./pages/api/admin/login.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/admin/pricelist/create.astro", _page9],
    ["src/pages/admin/pricelist/[id]/edit.astro", _page10],
    ["src/pages/admin/pricelist.astro", _page11],
    ["src/pages/admin/index.astro", _page12],
    ["src/pages/api/admin/collections.ts", _page13],
    ["src/pages/api/admin/content.ts", _page14],
    ["src/pages/api/admin/login.ts", _page15],
